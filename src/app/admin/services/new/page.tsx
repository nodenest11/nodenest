...
export default function NewService() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Prepare service data (set order)
      ...
      // Create new service
      const savedServiceId = await ServiceService.create(newService);
      if (savedServiceId) {
    ...
    <div className="w-full min-h-screen bg-[var(--background)] p-4">
      ...
      <div className="mb-8 border-b border-[var(--border-color)] pb-4">
        <div className="flex justify-between items-center mb-4">
          <h1 className="text-2xl font-bold text-[var(--foreground)]">Create New Service</h1>
          <div className="flex space-x-3">
            <GeminiHelper 
              contentType="service"
              buttonText="AI Service Creator" 
